  ...
  <div class="player" v-show="playlist.length>0">
        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <progress-bar :percent="percent" @percentChange="songTimeChange"></progress-bar>
            </div>
    ...
    <transition name="mini">
      <div class="mini-player"
        ...
        <div class="mini-rt">
          <div class="control">
            <progressCircle :radius="progressCircleRadius" :percent="percent">
              <i @click.stop="togglePlay" class="icon-mini" :class="playIconMin"></i>
            </progressCircle>
          </div>
          <div class="control">
  ...
  export default {
    ...
    methods: {
      ...
      middleTouchMove (e) {
        ...
        console.log('middleLyric percent', this.touch.percent)
      },
      middleTouchEnd (e) {
        let offsetWidth
        let opacity
