	...
	<div class="ad">
		<Card :bordered="false" :dis-hover="true" class="tip-txt">
			<p slot="title" class="card-title">
					...
					账户数据汇总<span class="tip-txt"> 数据说明：1. 账户余额实时更新，数据仅供参考。账户消耗每10分钟更新一次。2. “今日账户消耗”和“账户消耗”，仅包含竞价广告和品牌广告数据，不包含开屏联播数据。</span>
			</p>
		...
		<Card :bordered="false" :dis-hover="true" class="tip-txt margin-top-10">
			<p slot="title" class="card-title">
				<Icon type="ios-paper"></Icon>
				广告统计<span class="tip-txt"> 不包含已删除及旧平台的广告计划</span>
			</p>
