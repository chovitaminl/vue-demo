      ...
      <Card dis-hover bordered>
        ...
        <Form :label-width="126" label-position="left">
          <FormItem>
            ...
            <Select @on-change="handleChangeImportPlan" style="width:200px" v-model="unitSetting.campaign_name" :clearable="true">
              <Option v-for="(plan, index) in importDate.planlist" :value="plan.campaign_name" :key="index.id">{{plan.campaign_name}}</Option>
            </Select>
            <Select @on-change="handleChangeImportUnit" style="width:200px" v-model="unitSetting.adgroup_name" :clearable="true">
