...
.tip-content .tip{display: inline-block;padding-left: 5px;padding-right: 5px;}
.tip-content .tip::before{content: '';display: inline-block;width: 13px;height: 13px;vertical-align: text-bottom;}
.tip-content .tip:nth-of-type(1)::before{background-color: #1ba3f4;}
.tip-content .tip:nth-of-type(2)::before{background-color: #ccc;}
.day-container li{display: inline-block;vertical-align: middle;height: 30px; line-height: 30px;}
.week-th{width:88px;}
.hour-th{width: 30px;}
  ...
  <div class="week-picker-container">
    <div class="tip-bar clearfix">
      ...
      <div class="tip-content">
        <div class="tip">投放时间段</div>
        <div class="tip">暂停时间段</div>
      </div>
    </div>
    <ul class="week-container">
      <li class="day-line">
        <ul ref="hourChecker" @click="handleHourChecker" class="day-container">
          <li class="week-th"></li>
          <li v-for="v in allHour" class="hour-th cursor-pointer ljy-icon icon-download" :class="{'icon-active': 1===1}" :key="v"></li>
        </ul>
      </li>
      <li class="day-line">
...
export default {
  ...
  methods: {
    ...
    handleActionList(e) {
      ...
      switch (target) {
        case 'weekday-hook':
          ...
          this.$emit('input', this.weekStatus)
          break
        case 'weekend-hook':
    ...
    handleHour(type, index, value) {
      console.log('get', type, index, typeof index, value, typeof value)
      if ('1' === value) {
