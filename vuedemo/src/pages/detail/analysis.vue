  ...
  <div class="sales-board">
    ...
    <div class="sales-board-form">
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <v-chooser :selections="periodLists" @on-change="onParamChange('period',$event)"></v-chooser>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">
        ...
        <div class="sales-board-line-right">
          <v-mul-chooser :selections="versionLists" @on-change="onParamChange('versions',$event)"></v-mul-chooser>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">
...
<script type="text/ecmascript-6">
  import VSelection from '../../components/base/seclection.vue';
  import VCounter from '../../components/base/counter.vue';
  import VChooser from '../../components/base/chooser.vue';
  import VMulChooser from '../../components/base/multipliesChooser.vue';
  ...
  export default {
    ...
    methods: {
      ...
      getPrice() {
        let buyVersionArray = _.map(this.version, (item, index) => {
          console.log('map the buy versions:', item, index)
          return item.value1
        })
        let reqParams = {
    ...
    mounted() {
      ...
      this.version = [this.versionLists[0]]
      this.period = this.periodLists[0]
      this.getPrice()
    }
  }
</script>
